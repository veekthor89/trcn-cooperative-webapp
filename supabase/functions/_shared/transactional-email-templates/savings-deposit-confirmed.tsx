...
const SavingsDepositConfirmedEmail = ({ memberName, amount = '0', newBalance = '0' }: SavingsDepositProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>₦{amount} has been added to your savings</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Hr style={hr} />
        <Heading style={h2}>Savings Deposit — ₦{amount}</Heading>
        <Text style={text}>
          {memberName ? `Dear ${memberName},` : 'Dear Member,'}
        </Text>
        <Text style={text}>
          <strong>₦{amount}</strong> has been added to your savings. Your new balance is <strong>₦{newBalance}</strong>.
        </Text>
        <Hr style={hr} />
        <Text style={footer}>
...
export const template = {
  component: SavingsDepositConfirmedEmail,
  subject: (data: Record<string, any>) => `Savings Deposit - ₦${data.amount || '0'}`,
  displayName: 'Savings deposit confirmed',
  previewData: { memberName: 'Onyia Christiana', amount: '25,000', newBalance: '450,000' },
